...
var options = minimist_1["default"](process.argv.slice(2), {
    string: ["devDist"],
...
var lib = {
    ...
    dist: {
        packageJsonMap: function (old) {
            var version = options.devDist !== undefined ? old.version + "-build." + options.devDist : old.version;
...
var libTasks = lib_1.registerLibTasks(gulp_1["default"], lib);
mocha_1.registerMochaTasks(gulp_1["default"], test);
