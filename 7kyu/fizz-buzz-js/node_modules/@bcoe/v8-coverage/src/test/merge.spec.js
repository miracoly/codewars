...
function loadFixture(name) {
    var content = fs_1["default"].readFileSync(path_1["default"].resolve(FIXTURES_DIR, name + ".json"), { encoding: "UTF-8" });
        ...
        var _loop_1 = function (sourceFile) {
            ...
            describe(relPath, function () {
                ...
                var _loop_2 = function (item) {
                    var test = function () {
                        var actual = lib_1.mergeProcessCovs(item.inputs);
    ...
    describe("benches", function () {
        var _loop_3 = function (bench) {
            ...
            if (BENCHES_TO_SKIP.has(name_1)) {
                it.skip(name_1 + " (skipped: too large for CI)", testBench);
            }
            else {
                it(name_1, testBench);
            }
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 2:
                                inputs = _a.sent();
                                expectedPath = path_1["default"].join(BENCHES_DIR, name_1 + ".json");
                            ...
                            case 3:
                                ...
                                startTime = Date.now();
                                actual = lib_1.mergeProcessCovs(inputs);
                                endTime = Date.now();
                                console.error("Time (" + name_1 + "): " + (endTime - startTime) / 1000);
                                chai_1["default"].assert.deepEqual(actual, expected);
                                console.error("OK: " + name_1);
                                return [2 /*return*/];
                        }
                    });
                });
