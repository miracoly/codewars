...
--    describe "rot13" $ do
--      it "test" $
--        f [("fan1", "f1", 3), ("fan1", "f2", 3), ("fan2", "f1", 5)] `shouldBe` ["fan1", "fan2"]
--        f [("fan1", "f1", 3), ("fan1", "f2", 3), ("fan3", "f2", 2), ("fan3", "f2", 3), ("fan2", "f1", 5)] `shouldBe` ["fan1", "fan2"]
--        f [("fan1", "f1", 3), ("fan1", "f2", 4), ("fan2", "f1", 5)] `shouldBe` ["fan2"]
